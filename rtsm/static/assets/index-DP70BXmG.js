...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hr,depthTest:!1,depthWrite:!1})}function Th(){return new Kr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wu(),fragmentShader:`
		...
		`,blending:hr,depthTest:!1,depthWrite:!1})}function bh(){return new Kr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wu(),fragmentShader:`
		...
		`,blending:hr,depthTest:!1,depthWrite:!1})}function wu(){return`
	...
	`}function gx(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Qc||l===eu,u=l===Ws||l===Xs;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let f=e.get(a);return t===null&&(t=new yh(i)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),e.set(a,f),f.texture}else{if(e.has(a))return e.get(a).texture;{const f=a.image;if(c&&f&&f.height>0||u&&f&&r(f)){t===null&&(t=new yh(i));const d=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,d),a.addEventListener("dispose",s),d.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function _x(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function vx(i,e,t,n){const r={},s=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const v in d.attributes)e.remove(d.attributes[v]);for(const v in d.morphAttributes){const M=d.morphAttributes[v];for(let p=0,h=M.length;p<h;p++)e.remove(M[p])}d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(f,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const v in d)e.update(d[v],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const v in m){const M=m[v];for(let p=0,h=M.length;p<h;p++)e.update(M[p],i.ARRAY_BUFFER)}}function c(f){const d=[],m=f.index,v=f.attributes.position;let M=0;if(m!==null){const x=m.array;M=m.version;for(let _=0,y=x.length;_<y;_+=3){const D=x[_+0],b=x[_+1],R=x[_+2];d.push(D,b,b,R,R,D)}}else if(v!==void 0){const x=v.array;M=v.version;for(let _=0,y=x.length/3-1;_<y;_+=3){const D=_+0,b=_+1,R=_+2;d.push(D,b,b,R,R,D)}}else return;const p=new(gp(d)?yp:Sp)(d,1);p.version=M;const h=s.get(f);h&&e.remove(h),s.set(f,p)}function u(f){const d=s.get(f);if(d){const m=f.index;m!==null&&d.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function xx(i,e,t,n){const r=n.isWebGL2;let s;function o(m){s=m}let a,l;function c(m){a=m.type,l=m.bytesPerElement}function u(m,v){i.drawElements(s,v,a,m*l),t.update(v,s,1)}function f(m,v,M){if(M===0)return;let p,h;if(r)p=i,h="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),h="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[h](s,v,a,m*l,M),t.update(v,s,M)}function d(m,v,M){if(M===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<M;h++)this.render(m[h]/l,v[h]);else{p.multiDrawElementsWEBGL(s,v,0,a,m,0,M);let h=0;for(let x=0;x<M;x++)h+=v[x];t.update(h,s,1)}}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=f,this.renderMultiDraw=d}function Mx(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Sx(i,e){return i[0]-e[0]}function yx(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Ex(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new ln,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,f){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const v=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,M=v!==void 0?v.length:0;let p=s.get(u);if(p===void 0||p.count!==M){let B=function(){J.dispose(),s.delete(u),u.removeEventListener("dispose",B)};var m=B;p!==void 0&&p.texture.dispose();const _=u.morphAttributes.position!==void 0,y=u.morphAttributes.normal!==void 0,D=u.morphAttributes.color!==void 0,b=u.morphAttributes.position||[],R=u.morphAttributes.normal||[],Y=u.morphAttributes.color||[];let T=0;_===!0&&(T=1),y===!0&&(T=2),D===!0&&(T=3);let A=u.attributes.position.count*T,I=1;A>e.maxTextureSize&&(I=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const q=new Float32Array(A*I*4*M),J=new xp(q,A,I,M);J.type=fr,J.needsUpdate=!0;const N=T*4;for(let V=0;V<M;V++){const W=b[V],ie=R[V],te=Y[V],Q=A*I*4*V;for(let ae=0;ae<W.count;ae++){const re=ae*N;_===!0&&(o.fromBufferAttribute(W,ae),q[Q+re+0]=o.x,q[Q+re+1]=o.y,q[Q+re+2]=o.z,q[Q+re+3]=0),y===!0&&(o.fromBufferAttribute(ie,ae),q[Q+re+4]=o.x,q[Q+re+5]=o.y,q[Q+re+6]=o.z,q[Q+re+7]=0),D===!0&&(o.fromBufferAttribute(te,ae),q[Q+re+8]=o.x,q[Q+re+9]=o.y,q[Q+re+10]=o.z,q[Q+re+11]=te.itemSize===4?o.w:1)}}p={count:M,texture:J,size:new Ye(A,I)},s.set(u,p),u.addEventListener("dispose",B)}let h=0;for(let _=0;_<d.length;_++)h+=d[_];const x=u.morphTargetsRelative?1:1-h;f.getUniforms().setValue(i,"morphTargetBaseInfluence",x),f.getUniforms().setValue(i,"morphTargetInfluences",d),f.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),f.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const v=d===void 0?0:d.length;let M=n[u.id];if(M===void 0||M.length!==v){M=[];for(let y=0;y<v;y++)M[y]=[y,0];n[u.id]=M}for(let y=0;y<v;y++){const D=M[y];D[0]=y,D[1]=d[y]}M.sort(yx);for(let y=0;y<8;y++)y<v&&M[y][1]?(a[y][0]=M[y][0],a[y][1]=M[y][1]):(a[y][0]=Number.MAX_SAFE_INTEGER,a[y][1]=0);a.sort(Sx);const p=u.morphAttributes.position,h=u.morphAttributes.normal;let x=0;for(let y=0;y<8;y++){const D=a[y],b=D[0],R=D[1];b!==Number.MAX_SAFE_INTEGER&&R?(p&&u.getAttribute("morphTarget"+y)!==p[b]&&u.setAttribute("morphTarget"+y,p[b]),h&&u.getAttribute("morphNormal"+y)!==h[b]&&u.setAttribute("morphNormal"+y,h[b]),r[y]=R,x+=R):(p&&u.hasAttribute("morphTarget"+y)===!0&&u.deleteAttribute("morphTarget"+y),h&&u.hasAttribute("morphNormal"+y)===!0&&u.deleteAttribute("morphNormal"+y),r[y]=0)}const _=u.morphTargetsRelative?1:1-x;f.getUniforms().setValue(i,"morphTargetBaseInfluence",_),f.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function Tx(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class Rp extends Un{constructor(e,t,n,r,s,o,a,l,c,u){if(u=u!==void 0?u:Yr,u!==Yr&&u!==Ys)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Yr&&(n=ur),n===void 0&&u===Ys&&(n=Xr),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:En,this.minFilter=l!==void 0?l:En,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Cp=new Un,Lp=new Rp(1,1);Lp.compareFunction=mp;const Pp=new xp,Dp=new l_,Up=new bp,Ah=[],wh=[],Rh=new Float32Array(16),Ch=new Float32Array(9),Lh=new Float32Array(4);function to(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Ah[r];if(s===void 0&&(s=new Float32Array(r),Ah[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function Jt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Qt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function _l(i,e){let t=wh[e];t===void 0&&(t=new Int32Array(e),wh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function bx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Ax(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;i.uniform2fv(this.addr,e),Qt(t,e)}}function wx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Jt(t,e))return;i.uniform3fv(this.addr,e),Qt(t,e)}}function Rx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;i.uniform4fv(this.addr,e),Qt(t,e)}}function Cx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;Lh.set(n),i.uniformMatrix2fv(this.addr,!1,Lh),Qt(t,n)}}function Lx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;Ch.set(n),i.uniformMatrix3fv(this.addr,!1,Ch),Qt(t,n)}}function Px(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Jt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Qt(t,e)}else{if(Jt(t,n))return;Rh.set(n),i.uniformMatrix4fv(this.addr,!1,Rh),Qt(t,n)}}function Dx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Ux(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;i.uniform2iv(this.addr,e),Qt(t,e)}}function Ix(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;i.uniform3iv(this.addr,e),Qt(t,e)}}function Nx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;i.uniform4iv(this.addr,e),Qt(t,e)}}function Fx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ox(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;i.uniform2uiv(this.addr,e),Qt(t,e)}}function Bx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;i.uniform3uiv(this.addr,e),Qt(t,e)}}function zx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;i.uniform4uiv(this.addr,e),Qt(t,e)}}function kx(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Lp:Cp;t.setTexture2D(e||s,r)}function Hx(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Dp,r)}function Gx(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Up,r)}function Vx(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Pp,r)}function Wx(i){switch(i){case 5126:return bx;case 35664:return Ax;case 35665:return wx;case 35666:return Rx;case 35674:return Cx;case 35675:return Lx;case 35676:return Px;case 5124:case 35670:return Dx;case 35667:case 35671:return Ux;case 35668:case 35672:return Ix;case 35669:case 35673:return Nx;case 5125:return Fx;case 36294:return Ox;case 36295:return Bx;case 36296:return zx;case 35678:case 36198:case 36298:case 36306:case 35682:return kx;case 35679:case 36299:case 36307:return Hx;case 35680:case 36300:case 36308:case 36293:return Gx;case 36289:case 36303:case 36311:case 36292:return Vx}}function Xx(i,e){i.uniform1fv(this.addr,e)}function Yx(i,e){const t=to(e,this.size,2);i.uniform2fv(this.addr,t)}function qx(i,e){const t=to(e,this.size,3);i.uniform3fv(this.addr,t)}function jx(i,e){const t=to(e,this.size,4);i.uniform4fv(this.addr,t)}function $x(i,e){const t=to(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Kx(i,e){const t=to(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Zx(i,e){const t=to(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Jx(i,e){i.uniform1iv(this.addr,e)}function Qx(i,e){i.uniform2iv(this.addr,e)}function eM(i,e){i.uniform3iv(this.addr,e)}function tM(i,e){i.uniform4iv(this.addr,e)}function nM(i,e){i.uniform1uiv(this.addr,e)}function iM(i,e){i.uniform2uiv(this.addr,e)}function rM(i,e){i.uniform3uiv(this.addr,e)}function sM(i,e){i.uniform4uiv(this.addr,e)}function oM(i,e,t){const n=this.cache,r=e.length,s=_l(t,r);Jt(n,s)||(i.uniform1iv(this.addr,s),Qt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Cp,s[o])}function aM(i,e,t){const n=this.cache,r=e.length,s=_l(t,r);Jt(n,s)||(i.uniform1iv(this.addr,s),Qt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Dp,s[o])}function lM(i,e,t){const n=this.cache,r=e.length,s=_l(t,r);Jt(n,s)||(i.uniform1iv(this.addr,s),Qt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Up,s[o])}function cM(i,e,t){const n=this.cache,r=e.length,s=_l(t,r);Jt(n,s)||(i.uniform1iv(this.addr,s),Qt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Pp,s[o])}function uM(i){switch(i){case 5126:return Xx;case 35664:return Yx;case 35665:return qx;case 35666:return jx;case 35674:return $x;case 35675:return Kx;case 35676:return Zx;case 5124:case 35670:return Jx;case 35667:case 35671:return Qx;case 35668:case 35672:return eM;case 35669:case 35673:return tM;case 5125:return nM;case 36294:return iM;case 36295:return rM;case 36296:return sM;case 35678:case 36198:case 36298:case 36306:case 35682:return oM;case 35679:case 36299:case 36307:return aM;case 35680:case 36300:case 36308:case 36293:return lM;case 36289:case 36303:case 36311:case 36292:return cM}}class fM{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Wx(t.type)}}class hM{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=uM(t.type)}}class dM{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const gc=/(\w+)(\])?(\[|\.)?/g;function Ph(i,e){i.seq.push(e),i.map[e.id]=e}function pM(i,e,t){const n=i.name,r=n.length;for(gc.lastIndex=0;;){const s=gc.exec(n),o=gc.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Ph(t,c===void 0?new fM(a,i,e):new hM(a,i,e));break}else{let f=t.map[a];f===void 0&&(f=new dM(a),Ph(t,f)),t=f}}}class ja{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);pM(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Dh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const mM=37297;let gM=0;function _M(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function vM(i){const e=Tt.getPrimaries(Tt.workingColorSpace),t=Tt.getPrimaries(i);let n;switch(e===t?n="":e===el&&t===Qa?n="LinearDisplayP3ToLinearSRGB":e===Qa&&t===el&&(n="LinearSRGBToLinearDisplayP3"),i){case ji:case pl:return[n,"LinearTransferOETF"];case hn:case Eu:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Uh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+_M(i.getShaderSource(e),o)}else return r}function xM(i,e){const t=vM(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function MM(i,e){let t;switch(e){case Cg:t="Linear";break;case Lg:t="Reinhard";break;case Pg:t="OptimizedCineon";break;case Dg:t="ACESFilmic";break;case Ig:t="AgX";break;case Ug:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function SM(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Os).join(`
`)}function yM(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Os).join(`
`)}function EM(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function TM(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Os(i){return i!==""}function Ih(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Nh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const bM=/^[ \t]*#include +<([\w\d./]+)>/gm;function au(i){return i.replace(bM,wM)}const AM=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function wM(i,e){let t=it[e];if(t===void 0){const n=AM.get(e);if(n!==void 0)t=it[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return au(t)}const RM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fh(i){return i.replace(RM,CM)}function CM(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Oh(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function LM(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===rp?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ig?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Fi&&(e="SHADOWMAP_TYPE_VSM"),e}function PM(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ws:case Xs:e="ENVMAP_TYPE_CUBE";break;case dl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function DM(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Xs:e="ENVMAP_MODE_REFRACTION";break}return e}function UM(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case sp:e="ENVMAP_BLENDING_MULTIPLY";break;case wg:e="ENVMAP_BLENDING_MIX";break;case Rg:e="ENVMAP_BLENDING_ADD";break}return e}function IM(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function NM(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=LM(t),c=PM(t),u=DM(t),f=UM(t),d=IM(t),m=t.isWebGL2?"":SM(t),v=yM(t),M=EM(s),p=r.createProgram();let h,x,_=t.glslVersion?"#version "+t.glslVersion+`
...
`)==-1?[On]:On.split(/\n/gm);for(let xn=0;xn<Lr.length;xn++){let Sf=Lr[xn];Et?(f.save(),f.translate(O,X+xn*Fn),f.rotate(Et),f.fillText(Sf,0,0),f.restore()):f.fillText(Sf,O,X+xn*Fn)}}}$e.show&&Pl($n,$e.filter(n,ht,g,we,lt),P,C,Gt,Ht,Rt($e.width*vt,3),$e.stroke(n,g),$e.dash,$e.cap);let xi=S.grid;xi.show&&Pl($n,xi.filter(n,ht,g,we,lt),P,P==0?2:1,P==0?Oe:Ge,P==0?ye:Ce,Rt(xi.width*vt,3),xi.stroke(n,g),xi.dash,xi.cap),ze.show&&Pl([Gt],[1],P==0?1:0,P==0?1:2,P==1?Oe:Ge,P==1?ye:Ce,Rt(ze.width*vt,3),ze.stroke(n,g),ze.dash,ze.cap)}rn("drawAxes")}function is(g){x.forEach((S,C)=>{C>0&&(S._paths=null,g&&(r==1?(S.min=null,S.max=null):S.facets.forEach(P=>{P.min=null,P.max=null})))})}let sa=!1,Dl=!1,lo=[];function Hm(){Dl=!1;for(let g=0;g<lo.length;g++)rn(...lo[g]);lo.length=0}function rs(){sa||(my(nf),sa=!0)}function Gm(g,S=!1){sa=!0,Dl=S,g(n),nf(),S&&lo.length>0&&queueMicrotask(Hm)}n.batch=Gm;function nf(){if(U&&(wi(),U=!1),De&&(He(),De=!1),pe){if(Ut(m,Is,fe),Ut(m,So,Me),Ut(m,Lo,ee),Ut(m,Po,ne),Ut(v,Is,fe),Ut(v,So,Me),Ut(v,Lo,ee),Ut(v,Po,ne),Ut(d,Lo,ue),Ut(d,Po,ce),u.width=jt(ue*vt),u.height=jt(ce*vt),_.forEach(({_el:g,_show:S,_size:C,_pos:P,side:O})=>{if(g!=null)if(S){let X=O===3||O===0?C:0,oe=O%2==1;Ut(g,oe?"left":"top",P-X),Ut(g,oe?"width":"height",C),Ut(g,oe?"top":"left",oe?Me:fe),Ut(g,oe?"height":"width",oe?ne:ee),hu(g,Gr)}else Hn(g,Gr)}),Qe=yt=un=In=bt=nt=Ar=Ct=zt=null,kt=1,fo(!0),fe!=Fe||Me!=qe||ee!=le||ne!=rt){is(!1);let g=ee/le,S=ne/rt;if(ve&&!Ae&&z.left>=0){z.left*=g,z.top*=S,ss&&Mi(ss,jt(z.left),0,ee,ne),os&&Mi(os,0,jt(z.top),ee,ne);for(let C=0;C<Rn.length;C++){let P=Rn[C];P!=null&&(ri[C]*=g,bi[C]*=S,Mi(P,Jn(ri[C]),Jn(bi[C]),ee,ne))}}if(Pt.show&&!he&&Pt.left>=0&&Pt.width>0){Pt.left*=g,Pt.width*=g,Pt.top*=S,Pt.height*=S;for(let C in Bl)Ut(cs,C,Pt[C])}Fe=fe,qe=Me,le=ee,rt=ne}rn("setSize"),pe=!1}ue>0&&ce>0&&(f.clearRect(0,0,u.width,u.height),rn("drawClear"),Y.forEach(g=>g()),rn("draw")),Pt.show&&he&&(oa(Pt),he=!1),ve&&Ae&&(Cr(null,!0,!1),Ae=!1),re.show&&re.live&&F&&(Fl(),F=!1),l||(l=!0,n.status=1,rn("ready")),We=!1,sa=!1}n.redraw=(g,S)=>{De=S||!1,g!==!1?Ji(b,I.min,I.max):rs()};function Ul(g,S){let C=y[g];if(C.from==null){if(K==0){let P=C.range(n,S.min,S.max,g);S.min=P[0],S.max=P[1]}if(S.min>S.max){let P=S.min;S.min=S.max,S.max=P}if(K>1&&S.min!=null&&S.max!=null&&S.max-S.min<1e-16)return;g==b&&C.distr==2&&K>0&&(S.min=hi(S.min,e[0]),S.max=hi(S.max,e[0]),S.min==S.max&&S.max++),B[g]=S,U=!0,rs()}}n.setScale=Ul;let Il,Nl,ss,os,rf,sf,as,ls,of,af,Lt,Ft,Zi=!1;const fn=z.drag;let tn=fn.x,nn=fn.y;ve&&(z.x&&(Il=Zn(zS,v)),z.y&&(Nl=Zn(kS,v)),I.ori==0?(ss=Il,os=Nl):(ss=Nl,os=Il),Lt=z.left,Ft=z.top);const Pt=n.select=Yt({show:!0,over:!0,left:0,width:0,top:0,height:0},i.select),cs=Pt.show?Zn(BS,Pt.over?v:m):null;function oa(g,S){if(Pt.show){for(let C in g)Pt[C]=g[C],C in Bl&&Ut(cs,C,g[C]);S!==!1&&rn("setSelect")}}n.setSelect=oa;function Vm(g){if(x[g].show)se&&hu(be[g],Gr);else if(se&&Hn(be[g],Gr),ve){let C=Ti?Rn[0]:Rn[g];C!=null&&Mi(C,-10,-10,ee,ne)}}function Ji(g,S,C){Ul(g,{min:S,max:C})}function gi(g,S,C,P){S.focus!=null&&jm(g),S.show!=null&&x.forEach((O,X)=>{X>0&&(g==X||g==null)&&(O.show=S.show,Vm(X),r==2?(Ji(O.facets[0].scale,null,null),Ji(O.facets[1].scale,null,null)):Ji(O.scale,null,null),rs())}),C!==!1&&rn("setSeries",g,S),P&&ho("setSeries",n,g,S)}n.setSeries=gi;function Wm(g,S){Yt(D[g],S)}function Xm(g,S){g.fill=ut(g.fill||null),g.dir=dt(g.dir,-1),S=S??D.length,D.splice(S,0,g)}function Ym(g){g==null?D.length=0:D.splice(g,1)}n.addBand=Xm,n.setBand=Wm,n.delBand=Ym;function qm(g,S){x[g].alpha=S,ve&&Rn[g]!=null&&(Rn[g].style.opacity=S),se&&be[g]&&(be[g].style.opacity=S)}let Ri,Qi,Rr;const us={focus:!0};function jm(g){if(g!=Rr){let S=g==null,C=gt.alpha!=1;x.forEach((P,O)=>{if(r==1||O>0){let X=S||O==0||O==g;P._focus=S?null:X,C&&qm(O,X?1:gt.alpha)}}),Rr=g,C&&rs()}}se&&cn&&E(cd,ge,g=>{z._lock||(St(g),Rr!=null&&gi(null,us,!0,Wt.setSeries))});function _i(g,S,C){let P=y[S];C&&(g=g/vt-(P.ori==1?Me:fe));let O=ee;P.ori==1&&(O=ne,g=O-g),P.dir==-1&&(g=O-g);let X=P._min,oe=P._max,de=g/O,_e=X+(oe-X)*de,we=P.distr;return we==3?js(10,_e):we==4?iy(_e,P.asinh):we==100?P.bwd(_e):_e}function $m(g,S){let C=_i(g,b,S);return hi(C,e[0],G,xe)}n.valToIdx=g=>hi(g,e[0]),n.posToIdx=$m,n.posToVal=_i,n.valToPos=(g,S,C)=>y[S].ori==0?s(g,y[S],C?Ce:ee,C?Ge:0):o(g,y[S],C?ye:ne,C?Oe:0),n.setCursor=(g,S,C)=>{Lt=g.left,Ft=g.top,Cr(null,S,C)};function lf(g,S){Ut(cs,Is,Pt.left=g),Ut(cs,Lo,Pt.width=S)}function cf(g,S){Ut(cs,So,Pt.top=g),Ut(cs,Po,Pt.height=S)}let co=I.ori==0?lf:cf,uo=I.ori==1?lf:cf;function Km(){if(se&&re.live)for(let g=r==2?1:0;g<x.length;g++){if(g==0&&xt)continue;let S=re.values[g],C=0;for(let P in S)Ke[g][C++].firstChild.nodeValue=S[P]}}function Fl(g,S){if(g!=null&&(g.idxs?g.idxs.forEach((C,P)=>{ae[P]=C}):ay(g.idx)||ae.fill(g.idx),re.idx=ae[0]),se&&re.live){for(let C=0;C<x.length;C++)(C>0||r==1&&!xt)&&Zm(C,ae[C]);Km()}F=!1,S!==!1&&rn("setLegend")}n.setLegend=Fl;function Zm(g,S){let C=x[g],P=g==0&&q==2?Ne:e[g],O;xt?O=C.values(n,g,S)??Ue:(O=C.value(n,S==null?null:P[S],g,S),O=O==null?Ue:{_:O}),re.values[g]=O}function Cr(g,S,C){of=Lt,af=Ft,[Lt,Ft]=z.move(n,Lt,Ft),z.left=Lt,z.top=Ft,ve&&(ss&&Mi(ss,jt(Lt),0,ee,ne),os&&Mi(os,0,jt(Ft),ee,ne));let P,O=G>xe;Ri=wt,Qi=null;let X=I.ori==0?ee:ne,oe=I.ori==1?ee:ne;if(Lt<0||K==0||O){P=z.idx=null;for(let de=0;de<x.length;de++){let _e=Rn[de];_e!=null&&Mi(_e,-10,-10,ee,ne)}cn&&gi(null,us,!0,g==null&&Wt.setSeries),re.live&&(ae.fill(P),F=!0)}else{let de,_e,we;r==1&&(de=I.ori==0?Lt:Ft,_e=_i(de,b),P=z.idx=hi(_e,e[0],G,xe),we=J(e[0][P],I,X,0));let Re=-10,Pe=-10,et=0,_t=0,ht=!0,lt="",$e="";for(let ze=r==2?1:0;ze<x.length;ze++){let Dt=x[ze],Ht=ae[ze],sn=Ht==null?null:r==1?e[ze][Ht]:e[ze][1][Ht],Et=z.dataIdx(n,ze,P,_e),Gt=Et==null?null:r==1?e[ze][Et]:e[ze][1][Et];if(F=F||Gt!=sn||Et!=Ht,ae[ze]=Et,ze>0&&Dt.show){let Nn=Et==null?-10:Et==P?we:J(r==1?e[0][Et]:e[ze][0][Et],I,X,0),_n=Gt==null?-10:N(Gt,r==1?y[Dt.scale]:y[Dt.facets[1].scale],oe,0);if(cn&&Gt!=null){let jn=I.ori==1?Lt:Ft,si=$t(gt.dist(n,ze,Et,_n,jn));if(si<Ri){let vi=gt.bias;if(vi!=0){let Fn=_i(jn,Dt.scale),$n=Gt>=0?1:-1,oi=Fn>=0?1:-1;oi==$n&&(oi==1?vi==1?Gt>=Fn:Gt<=Fn:vi==1?Gt<=Fn:Gt>=Fn)&&(Ri=si,Qi=ze)}else Ri=si,Qi=ze}}if(F||Ti){let jn,si;I.ori==0?(jn=Nn,si=_n):(jn=_n,si=Nn);let vi,Fn,$n,oi,xi,vn,On=!0,Lr=je.bbox;if(Lr!=null){On=!1;let xn=Lr(n,ze);$n=xn.left,oi=xn.top,vi=xn.width,Fn=xn.height}else $n=jn,oi=si,vi=Fn=je.size(n,ze);if(vn=je.fill(n,ze),xi=je.stroke(n,ze),Ti)ze==Qi&&Ri<=gt.prox&&(Re=$n,Pe=oi,et=vi,_t=Fn,ht=On,lt=vn,$e=xi);else{let xn=Rn[ze];xn!=null&&(ri[ze]=$n,bi[ze]=oi,gd(xn,vi,Fn,On),pd(xn,vn,xi),Mi(xn,Jn($n),Jn(oi),ee,ne))}}}}if(Ti){let ze=gt.prox,Dt=Rr==null?Ri<=ze:Ri>ze||Qi!=Rr;if(F||Dt){let Ht=Rn[0];Ht!=null&&(ri[0]=Re,bi[0]=Pe,gd(Ht,et,_t,ht),pd(Ht,lt,$e),Mi(Ht,Jn(Re),Jn(Pe),ee,ne))}}}if(Pt.show&&Zi)if(g!=null){let[de,_e]=Wt.scales,[we,Re]=Wt.match,[Pe,et]=g.cursor.sync.scales,_t=g.cursor.drag;if(tn=_t._x,nn=_t._y,tn||nn){let{left:ht,top:lt,width:$e,height:ze}=g.select,Dt=g.scales[Pe].ori,Ht=g.posToVal,sn,Et,Gt,Nn,_n,jn=de!=null&&we(de,Pe),si=_e!=null&&Re(_e,et);jn&&tn?(Dt==0?(sn=ht,Et=$e):(sn=lt,Et=ze),Gt=y[de],Nn=J(Ht(sn,Pe),Gt,X,0),_n=J(Ht(sn+Et,Pe),Gt,X,0),co(mi(Nn,_n),$t(_n-Nn))):co(0,X),si&&nn?(Dt==1?(sn=ht,Et=$e):(sn=lt,Et=ze),Gt=y[_e],Nn=N(Ht(sn,et),Gt,oe,0),_n=N(Ht(sn+Et,et),Gt,oe,0),uo(mi(Nn,_n),$t(_n-Nn))):uo(0,oe)}else zl()}else{let de=$t(of-rf),_e=$t(af-sf);if(I.ori==1){let et=de;de=_e,_e=et}tn=fn.x&&de>=fn.dist,nn=fn.y&&_e>=fn.dist;let we=fn.uni;we!=null?tn&&nn&&(tn=de>=we,nn=_e>=we,!tn&&!nn&&(_e>de?nn=!0:tn=!0)):fn.x&&fn.y&&(tn||nn)&&(tn=nn=!0);let Re,Pe;tn&&(I.ori==0?(Re=as,Pe=Lt):(Re=ls,Pe=Ft),co(mi(Re,Pe),$t(Pe-Re)),nn||uo(0,oe)),nn&&(I.ori==1?(Re=as,Pe=Lt):(Re=ls,Pe=Ft),uo(mi(Re,Pe),$t(Pe-Re)),tn||co(0,X)),!tn&&!nn&&(co(0,0),uo(0,0))}if(fn._x=tn,fn._y=nn,g==null){if(C){if(Mf!=null){let[de,_e]=Wt.scales;Wt.values[0]=de!=null?_i(I.ori==0?Lt:Ft,de):null,Wt.values[1]=_e!=null?_i(I.ori==1?Lt:Ft,_e):null}ho(Ec,n,Lt,Ft,ee,ne,P)}if(cn){let de=C&&Wt.setSeries,_e=gt.prox;Rr==null?Ri<=_e&&gi(Qi,us,!0,de):Ri>_e?gi(null,us,!0,de):Qi!=Rr&&gi(Qi,us,!0,de)}}F&&(re.idx=P,Fl()),S!==!1&&rn("setCursor")}let er=null;Object.defineProperty(n,"rect",{get(){return er==null&&fo(!1),er}});function fo(g=!1){g?er=null:(er=v.getBoundingClientRect(),rn("syncRect",er))}function uf(g,S,C,P,O,X,oe){z._lock||Zi&&g!=null&&g.movementX==0&&g.movementY==0||(Ol(g,S,C,P,O,X,oe,!1,g!=null),g!=null?Cr(null,!0,!0):Cr(S,!0,!1))}function Ol(g,S,C,P,O,X,oe,de,_e){if(er==null&&fo(!1),St(g),g!=null)C=g.clientX-er.left,P=g.clientY-er.top;else{if(C<0||P<0){Lt=-10,Ft=-10;return}let[we,Re]=Wt.scales,Pe=S.cursor.sync,[et,_t]=Pe.values,[ht,lt]=Pe.scales,[$e,ze]=Wt.match,Dt=S.axes[0].side%2==1,Ht=I.ori==0?ee:ne,sn=I.ori==1?ee:ne,Et=Dt?X:O,Gt=Dt?O:X,Nn=Dt?P:C,_n=Dt?C:P;if(ht!=null?C=$e(we,ht)?a(et,y[we],Ht,0):-10:C=Ht*(Nn/Et),lt!=null?P=ze(Re,lt)?a(_t,y[Re],sn,0):-10:P=sn*(_n/Gt),I.ori==1){let jn=C;C=P,P=jn}}_e&&(S==null||S.cursor.event.type==Ec)&&((C<=1||C>=ee-1)&&(C=Br(C,ee)),(P<=1||P>=ne-1)&&(P=Br(P,ne))),de?(rf=C,sf=P,[as,ls]=z.move(n,C,P)):(Lt=C,Ft=P)}const Bl={width:0,height:0,left:0,top:0};function zl(){oa(Bl,!1)}let ff,hf,df,pf;function mf(g,S,C,P,O,X,oe){Zi=!0,tn=nn=fn._x=fn._y=!1,Ol(g,S,C,P,O,X,oe,!0,!1),g!=null&&(E(Tc,uu,gf,!1),ho(ad,n,as,ls,ee,ne,null));let{left:de,top:_e,width:we,height:Re}=Pt;ff=de,hf=_e,df=we,pf=Re}function gf(g,S,C,P,O,X,oe){Zi=fn._x=fn._y=!1,Ol(g,S,C,P,O,X,oe,!1,!0);let{left:de,top:_e,width:we,height:Re}=Pt,Pe=we>0||Re>0,et=ff!=de||hf!=_e||df!=we||pf!=Re;if(Pe&&et&&oa(Pt),fn.setScale&&Pe&&et){let _t=de,ht=we,lt=_e,$e=Re;if(I.ori==1&&(_t=_e,ht=Re,lt=de,$e=we),tn&&Ji(b,_i(_t,b),_i(_t+ht,b)),nn)for(let ze in y){let Dt=y[ze];ze!=b&&Dt.from==null&&Dt.min!=wt&&Ji(ze,_i(lt+$e,ze),_i(lt,ze))}zl()}else z.lock&&(z._lock=!z._lock,Cr(S,!0,g!=null));g!=null&&($(Tc,uu),ho(Tc,n,Lt,Ft,ee,ne,null))}function Jm(g,S,C,P,O,X,oe){if(z._lock)return;St(g);let de=Zi;if(Zi){let _e=!0,we=!0,Re=10,Pe,et;I.ori==0?(Pe=tn,et=nn):(Pe=nn,et=tn),Pe&&et&&(_e=Lt<=Re||Lt>=ee-Re,we=Ft<=Re||Ft>=ne-Re),Pe&&_e&&(Lt=Lt<as?0:ee),et&&we&&(Ft=Ft<ls?0:ne),Cr(null,!0,!0),Zi=!1}Lt=-10,Ft=-10,ae.fill(null),Cr(null,!0,!0),de&&(Zi=de)}function _f(g,S,C,P,O,X,oe){z._lock||(St(g),Je(),zl(),g!=null&&ho(ud,n,Lt,Ft,ee,ne,null))}function vf(){_.forEach(EE),me(n.width,n.height,!0)}jr(rl,Gs,vf);const fs={};fs.mousedown=mf,fs.mousemove=uf,fs.mouseup=gf,fs.dblclick=_f,fs.setSeries=(g,S,C,P)=>{let O=Wt.match[2];C=O(n,S,C),C!=-1&&gi(C,P,!0,!1)},ve&&(E(ad,v,mf),E(Ec,v,uf),E(ld,v,g=>{St(g),fo(!1)}),E(cd,v,Jm),E(ud,v,_f),vu.add(n),n.syncRect=fo);const aa=n.hooks=i.hooks||{};function rn(g,S,C){Dl?lo.push([g,S,C]):g in aa&&aa[g].forEach(P=>{P.call(null,n,S,C)})}(i.plugins||[]).forEach(g=>{for(let S in g.hooks)aa[S]=(aa[S]||[]).concat(g.hooks[S])});const xf=(g,S,C)=>C,Wt=Yt({key:null,setSeries:!1,filters:{pub:Sd,sub:Sd},scales:[b,x[1]?x[1].scale:null],match:[yd,yd,xf],values:[null,null]},z.sync);Wt.match.length==2&&Wt.match.push(xf),z.sync=Wt;const Mf=Wt.key,kl=pm(Mf);function ho(g,S,C,P,O,X,oe){Wt.filters.pub(g,S,C,P,O,X,oe)&&kl.pub(g,S,C,P,O,X,oe)}kl.sub(n);function Qm(g,S,C,P,O,X,oe){Wt.filters.sub(g,S,C,P,O,X,oe)&&fs[g](null,S,C,P,O,X,oe)}n.pub=Qm;function eg(){kl.unsub(n),vu.delete(n),L.clear(),du(rl,Gs,vf),c.remove(),ge==null||ge.remove(),rn("destroy")}n.destroy=eg;function Hl(){rn("init",i,e),tt(e||i.data,!1),B[b]?Ul(b,B[b]):Je(),he=Pt.show&&(Pt.width>0||Pt.height>0),Ae=F=!0,me(i.width,i.height)}return x.forEach(so),_.forEach(Cl),t?t instanceof HTMLElement?(t.appendChild(c),Hl()):t(n,Hl):Hl(),n}Kt.assign=Yt;Kt.fmtNum=Ou;Kt.rangeNum=sl;Kt.rangeLog=xl;Kt.rangeAsinh=Nu;Kt.orient=es;Kt.pxRatio=vt;Kt.join=py;Kt.fmtDate=zu,Kt.tzDate=by;Kt.sync=pm;{Kt.addGap=aE,Kt.clipGaps=yl;let i=Kt.paths={points:Mm};i.linear=ym,i.stepped=uE,i.bars=fE,i.spline=dE}const TE=document.getElementById("app"),ii=new Ip({antialias:!0,logarithmicDepthBuffer:!0});ii.setPixelRatio(Math.min(window.devicePixelRatio,2));ii.setSize(window.innerWidth,window.innerHeight);ii.shadowMap.enabled=!1;TE.appendChild(ii.domElement);const Zo=new cS;Zo.background=new ft(1118481);const dn=new ti(60,window.innerWidth/window.innerHeight,.01,2e3);dn.position.set(3,3,3);const pt=new AS(dn,ii.domElement);pt.minPolarAngle=1e-4;pt.maxPolarAngle=Math.PI-1e-4;pt.target.set(0,0,0);pt.update();Zo.add(new yS(16777215,.6));const Am=new SS(16777215,.6);Am.position.set(3,5,2);Zo.add(Am);const an=new Co;Zo.add(an);const bE=new TS(.5);an.add(bE);const AE=new wS;let Vn=null;function wE(){Vn&&(an.remove(Vn),Vn.geometry.dispose(),Vn.material.dispose(),Vn=null)}function RE(i){i.computeBoundingBox();const e=i.boundingBox;if(!e)return;const t=new k;e.getSize(t);const n=Math.max(t.x,t.y,t.z)*.5,r=Math.max(1,n*2.5);dn.position.set(r,r,r),dn.far=Math.max(2e3,n*20),dn.updateProjectionMatrix(),pt.target.set(0,0,0),pt.update(),Cm.copy(dn.position),Lm.copy(pt.target)}function CE(i){const e=URL.createObjectURL(i);AE.load(e,t=>{URL.revokeObjectURL(e),wE();const n=!!t.getAttribute("color");t.computeBoundingBox();const r=t.boundingBox;if(r){const l=new k;r.getCenter(l),t.translate(-l.x,-l.y,-l.z)}let s=1;if(r){const l=new k;r.getSize(l),s=Math.max(l.x,l.y,l.z)*.5}const o=Math.max(.001,s*.003),a=new Ru({size:o,vertexColors:n,sizeAttenuation:!0,depthWrite:!1});Vn=new Bp(t,a),Vn.frustumCulled=!1,an.add(Vn),RE(t)},void 0,()=>{URL.revokeObjectURL(e)})}const LE=1145848656,PE=1179468099,Wn=new Map;let cr=!1;const yn=document.getElementById("camera-feed"),gn=document.getElementById("camera-panel"),Wd=document.getElementById("camera-header");let Eo=null,ka=!1,Cc=!1,Mu=!0,Vr=0;var Jd;(Jd=document.getElementById("camera-toggle"))==null||Jd.addEventListener("click",i=>{i.stopPropagation(),gn==null||gn.classList.toggle("collapsed")});var Qd;(Qd=document.getElementById("camera-resize"))==null||Qd.addEventListener("click",i=>{i.stopPropagation(),gn&&(Cc=!Cc,gn.style.width=Cc?"400px":"240px")});var ep;(ep=document.getElementById("camera-rotate"))==null||ep.addEventListener("click",i=>{i.stopPropagation(),Mu=!Mu,wm()});if(gn&&Wd){let i=!1,e=0,t=0;Wd.addEventListener("mousedown",n=>{n.target.closest(".cam-btn")||(i=!0,e=n.clientX-gn.offsetLeft,t=n.clientY-gn.offsetTop,gn.style.transition="none",n.preventDefault())}),window.addEventListener("mousemove",n=>{if(!i)return;let r=n.clientX-e,s=n.clientY-t;r=Math.max(0,Math.min(r,window.innerWidth-gn.offsetWidth)),s=Math.max(32,Math.min(s,window.innerHeight-gn.offsetHeight)),gn.style.left=r+"px",gn.style.top=s+"px",gn.style.bottom="auto",gn.style.right="auto"}),window.addEventListener("mouseup",()=>{i&&(i=!1,gn.style.transition="")})}const Lc=document.getElementById("ui");var tp;(tp=document.getElementById("ui-toggle-row"))==null||tp.addEventListener("click",()=>{Lc==null||Lc.classList.toggle("collapsed")});function wm(){if(yn)if(Mu&&Vr>0){yn.style.transform=`rotate(90deg) scale(${Vr})`;const i=-(1/Vr-Vr)/2*100;yn.style.marginTop=i+"%",yn.style.marginBottom=i+"%"}else yn.style.transform="",yn.style.marginTop="",yn.style.marginBottom=""}function DE(i){if(!yn||ka)return;ka=!0;const t=new DataView(i).getUint32(4,!0),n=new Uint8Array(i,8,t);Eo&&URL.revokeObjectURL(Eo),Eo=URL.createObjectURL(new Blob([n],{type:"image/jpeg"})),requestAnimationFrame(()=>{if(!yn||!Eo){ka=!1;return}yn.src=Eo,Vr===0&&(yn.onload=()=>{if(Vr>0||!yn)return;const r=yn.naturalWidth,s=yn.naturalHeight;r>0&&s>0&&(Vr=r/s,wm(),yn.onload=null)}),ka=!1})}let Yu=0,Js=0;function Rm(i){const e=new Bt;return e.set(i[0],i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[13],i[14],i[15]),e}function UE(i){const e=new DataView(i),t=new Uint8Array(i),n=e.getUint32(0,!0);if(n!==LE)return console.warn("[ws] Invalid mesh_create magic:",n.toString(16)),null;const r=e.getUint16(4,!0),s=e.getUint32(6,!0);let o=10;const a=t.slice(o,o+r),l=new TextDecoder().decode(a);o+=r;const c=s*3*4,u=t.slice(o,o+c),f=new Float32Array(u.buffer,u.byteOffset,s*3);o+=c;const d=s*3,m=t.slice(o,o+d);o+=d;const v=e.getUint8(o);o+=1;let M=null;if(v){M=[];for(let p=0;p<16;p++)M.push(e.getFloat32(o+p*4,!0))}return{meshId:l,positions:f,colors:m,pose:M}}function IE(i,e,t,n){let r=Wn.get(i);if(!r){const o=new wn,a=new Ru({size:.008,vertexColors:!0,sizeAttenuation:!0});r=new Bp(o,a),r.frustumCulled=!1,r.matrixAutoUpdate=!1,an.add(r),Wn.set(i,r)}r.geometry.setAttribute("position",new Xn(e,3));const s=new Float32Array(t.length);for(let o=0;o<t.length;o++)s[o]=t[o]/255;r.geometry.setAttribute("color",new Xn(s,3)),r.geometry.computeBoundingSphere(),Js=0;for(const o of Wn.values()){const a=o.geometry.getAttribute("position");a&&(Js+=a.count)}if(n){const o=Rm(n);r.matrix.copy(o),Wn.size<=5&&console.log(`[debug-mesh] ${i} pose translation: [${n[3].toFixed(3)}, ${n[7].toFixed(3)}, ${n[11].toFixed(3)}]`)}}function NE(i,e){const t=Wn.get(i);if(!t){console.warn(`[ws] Pose update for unknown mesh: ${i}`);return}const n=Rm(e);t.matrix.copy(n),Yu++}function FE(i){const e=Wn.get(i);if(e){an.remove(e),e.geometry.dispose(),e.material.dispose(),Wn.delete(i),Js=0;for(const t of Wn.values()){const n=t.geometry.getAttribute("position");n&&(Js+=n.count)}}}function Jo(){for(const[,i]of Wn)an.remove(i),i.geometry.dispose(),i.material.dispose();Wn.clear(),Yu=0,Js=0,Oi()}let Tn=null,qu=!1;function ju(){const e=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/ws`;Tn=new WebSocket(e),Tn.binaryType="arraybuffer",Tn.onopen=()=>{cr=!0,console.log("[ws] Connected to demo server"),Oi(),fl()},Tn.onclose=()=>{cr=!1,Tn=null,console.log("[ws] Disconnected"),Oi(),fl(),qu||(console.log("[ws] Auto-reconnecting in 2s..."),setTimeout(ju,2e3))},Tn.onerror=()=>{},Tn.onmessage=t=>{if(t.data instanceof ArrayBuffer){if(t.data.byteLength>=4)if(new DataView(t.data).getUint32(0,!0)===PE)DE(t.data);else{const r=UE(t.data);r&&(IE(r.meshId,r.positions,r.colors,r.pose),Oi())}}else try{const n=JSON.parse(t.data);n.type==="mesh_update_pose"?(NE(n.mesh_id,n.pose),Oi()):n.type==="mesh_delete"?(FE(n.mesh_id),Oi()):n.type==="clear"?Jo():n.type==="stats"?console.log("[ws] Server stats:",n):n.type==="objects_update"?(Pn=n.objects||[],Pn.length>0&&Pn.filter(s=>s.label_scores&&Object.keys(s.label_scores).length>0).length===0&&console.warn("[ws] Objects received but none have label_scores - are you running the embedded RTSM visualization server?"),Tr(),ts(),Oi()):n.type==="runtime_analytics"&&VE(n)}catch{}}}function OE(i){Tn&&Tn.readyState===WebSocket.OPEN&&Tn.send(JSON.stringify({cmd:i}))}const Uo=new Map,To=new Map;let Pn=[],Ka=!0,Io=!1,Gi=new Map,Vs=!1,Gn=null,ui=null;function al(i,e="#ffffff"){const t=document.createElement("canvas"),n=t.getContext("2d");t.width=256,t.height=64,n.fillStyle="rgba(0,0,0,0.6)",n.fillRect(0,0,t.width,t.height),n.font="bold 24px system-ui, Arial",n.fillStyle=e,n.textAlign="center",n.textBaseline="middle",n.fillText(i,t.width/2,t.height/2);const r=new pS(t),s=new Np({map:r,transparent:!0}),o=new fS(s);return o.scale.set(.5,.125,1),o}function Tr(){var e,t,n;for(const[r,s]of Uo)if(!Pn.find(o=>o.id===r)){an.remove(s),s.geometry.dispose(),s.material.dispose(),Uo.delete(r);const o=To.get(r);o&&(an.remove(o),(e=o.material.map)==null||e.dispose(),o.material.dispose(),To.delete(r))}const i=Pn.filter(r=>r.xyz_world).length;if(i>0&&i<=5)for(const r of Pn.slice(0,3))r.xyz_world&&console.log(`[debug-obj] ${r.id.slice(0,8)} xyz: [${r.xyz_world[0].toFixed(3)}, ${r.xyz_world[1].toFixed(3)}, ${r.xyz_world[2].toFixed(3)}]`);for(const r of Pn){if(!r.xyz_world)continue;let s=Uo.get(r.id);if(!s){const u=new Lu(.03,16,16),f=new gl({color:r.confirmed?65416:16755200,transparent:!0,opacity:.8});s=new Ei(u,f),s.renderOrder=999,an.add(s),Uo.set(r.id,s)}s.position.set(r.xyz_world[0],r.xyz_world[1],r.xyz_world[2]);const o=!Vs||Gi.has(r.id),a=Ka&&(!Io||r.confirmed)&&o;s.visible=a,s.material.color.setHex(r.confirmed?65416:16755200),r.id===Xi?s.scale.set(1.8,1.8,1.8):s.scale.set(1,1,1);let l=To.get(r.id);const c=`${r.id.slice(0,6)} ${r.stability.toFixed(2)}`;l?((t=l.userData)==null?void 0:t.text)!==c&&(an.remove(l),(n=l.material.map)==null||n.dispose(),l.material.dispose(),l=al(c,r.confirmed?"#00ff88":"#ffaa00"),l.userData={text:c},an.add(l),To.set(r.id,l)):(l=al(c,r.confirmed?"#00ff88":"#ffaa00"),an.add(l),To.set(r.id,l)),l.position.set(r.xyz_world[0],r.xyz_world[1]+.08,r.xyz_world[2]),l.visible=a}BE()}function BE(){var n;const i=Xi?Pn.find(r=>r.id===Xi):null;if(!i||!i.xyz_world){Gn&&(Gn.visible=!1),ui&&(ui.visible=!1);return}if(!Gn){const r=new Cu(.06,.09,32),s=new gl({color:56831,transparent:!0,opacity:.9,side:yi,depthTest:!1,depthWrite:!1});Gn=new Ei(r,s),Gn.renderOrder=1e3,an.add(Gn)}ui||(ui=al("","#1e90ff"),ui.renderOrder=1001,an.add(ui)),Gn.position.set(i.xyz_world[0],i.xyz_world[1],i.xyz_world[2]),Gn.lookAt(dn.position),Gn.visible=!0;const e=`${i.id.slice(0,8)} | ${i.stability.toFixed(2)}`,t=al(e,"#00ddff");t.material.depthTest=!1,t.material.depthWrite=!1,t.position.set(i.xyz_world[0],i.xyz_world[1]+.12,i.xyz_world[2]),t.renderOrder=1001,t.visible=!0,ui&&(an.remove(ui),(n=ui.material.map)==null||n.dispose(),ui.material.dispose()),an.add(t),ui=t}function Oi(){const i=document.getElementById("hud");if(!i)return;const e=Pn.filter(t=>t.confirmed).length;i.innerHTML=["<b>RTSM Demo</b>",`WS: ${cr?'<span style="color:#0f0">connected</span>':'<span style="color:#f55">disconnected</span>'}`,`Meshes: ${Wn.size} | Points: ${Js.toLocaleString()}`,`Pose updates: ${Yu}`,`Objects: ${Pn.length} (${e} confirmed)`].join("<br>")}const Pc=document.getElementById("file"),Dc=document.getElementById("load"),Uc=document.getElementById("reset"),Ic=document.getElementById("flipX"),Nc=document.getElementById("flipY"),Fc=document.getElementById("flipZ"),Ha=document.getElementById("toggleObj"),Oc=document.getElementById("filterConfirmed"),Bc=document.getElementById("clearStream"),zc=document.getElementById("savePly"),kc=document.getElementById("rebuild"),zo=document.getElementById("disconnect"),ko=document.getElementById("reconnect"),Xd=document.getElementById("mode"),Nr=document.getElementById("rtsmReset"),Fr=document.getElementById("rtsmStats"),Hc=document.getElementById("object-panel"),Gc=document.getElementById("panel-title"),gr=document.getElementById("object-search"),bo=document.getElementById("panel-filter"),Ao=document.getElementById("panel-toggle"),Vc=document.getElementById("object-list");let Ga=!1,$u="",Xi=null,Bs=!1;const Yi=document.getElementById("snapshot-gallery"),Wc=document.getElementById("gallery-close"),_r=document.getElementById("gallery-images"),vr=document.getElementById("gallery-preview"),Yd=document.getElementById("gallery-info"),kn=document.getElementById("gallery-loading"),qd=document.getElementById("gallery-title"),ki=document.getElementById("ss-rotate");ki==null||ki.addEventListener("change",()=>{const i=`rotate(${ki.value}deg)`;vr&&(vr.style.transform=i),_r==null||_r.querySelectorAll(".gallery-thumb").forEach(e=>{e.style.transform=i})});let No=[];function zs(i){Xd&&(Xd.textContent=`Mode: ${i}`)}zs("Free");const Cm=dn.position.clone(),Lm=pt.target.clone();let ll=!1,cl=!1,ul=!1;function Qo(){an.scale.set(ll?-1:1,cl?-1:1,ul?-1:1)}Uc==null||Uc.addEventListener("click",()=>{dn.position.copy(Cm),dn.up.set(0,1,0),pt.target.copy(Lm),ll=cl=ul=!1,Qo(),pt.update(),zs("Free")});Ic==null||Ic.addEventListener("click",()=>{ll=!ll,Qo()});Nc==null||Nc.addEventListener("click",()=>{cl=!cl,Qo()});Fc==null||Fc.addEventListener("click",()=>{ul=!ul,Qo()});Dc==null||Dc.addEventListener("click",()=>{var e;const i=(e=Pc==null?void 0:Pc.files)==null?void 0:e[0];i&&CE(i)});Ha==null||Ha.addEventListener("click",()=>{Ka=!Ka,Tr(),Ha.textContent=Ka?"Hide Objects":"Show Objects"});Oc?Oc.addEventListener("click",()=>{Io=!Io,console.log("[demo] Filter toggled, showOnlyConfirmed:",Io),Tr(),Oc.textContent=Io?"Confirmed Only":"All"}):console.warn("[demo] filterConfirmedBtn not found");Ao==null||Ao.addEventListener("click",()=>{Ga=!Ga,Hc==null||Hc.classList.toggle("collapsed",Ga),Ao&&(Ao.textContent=Ga?"▲":"▼")});bo==null||bo.addEventListener("click",()=>{Bs=!Bs,bo.textContent=Bs?"Confirmed":"All",bo.classList.toggle("active",Bs),ts()});const Xc=document.getElementById("search-btn"),Yc=document.getElementById("show-all-btn"),qc=document.getElementById("search-threshold");async function Pm(){const i=gr==null?void 0:gr.value.trim();if(!i){console.log("[semantic-search] Empty query, showing all objects"),Dm();return}const e=parseFloat((qc==null?void 0:qc.value)||"0.0")||0;$u=i,console.log(`[semantic-search] Searching for: "${i}" (threshold=${e})`);try{const n=await(await fetch(`${Al}/search/semantic?query=${encodeURIComponent(i)}&top_k=10&threshold=${e}`)).json();if(console.log("[semantic-search] API response:",n),Gi.clear(),n.results)for(const r of n.results)Gi.set(r.id,r.score);Vs=!0,ts(),Tr(),console.log(`[semantic-search] Found ${Gi.size} matches`)}catch(t){console.error("[semantic-search] API call failed:",t),alert("Semantic search failed. Is RTSM running?")}}function Dm(){$u="",Gi.clear(),Vs=!1,gr&&(gr.value=""),ts(),Tr()}Xc==null||Xc.addEventListener("click",Pm);Yc==null||Yc.addEventListener("click",Dm);gr==null||gr.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),Pm())});function ts(){if(!Vc)return;let i;if(Vs?(i=Pn.filter(e=>Bs&&!e.confirmed?!1:Gi.has(e.id)),i.sort((e,t)=>{const n=Gi.get(e.id)||0;return(Gi.get(t.id)||0)-n})):i=Pn.filter(e=>!(Bs&&!e.confirmed)),Gc){const e=i.filter(t=>t.confirmed).length;Vs?Gc.textContent=`Search "${$u}": ${i.length} matches`:Gc.textContent=`Objects (${i.length}) — ${e} confirmed`}Vc.innerHTML=i.map(e=>{const t=e.id===Xi,n=Gi.get(e.id),r=Vs&&n!==void 0?`sim ${n.toFixed(2)}`:`${e.stability.toFixed(2)}`,s=e.confirmed?"confirmed":"proto";return`
    ...
    `}).join(""),Vc.querySelectorAll(".object-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-id");t&&zE(t)})})}function zE(i){Xi===i?(Xi=null,Yi==null||Yi.classList.remove("visible")):(Xi=i,kE(i)),ts(),Tr()}Wc==null||Wc.addEventListener("click",()=>{Yi==null||Yi.classList.remove("visible")});{const i=document.getElementById("gallery-header"),e=Yi;if(i&&e){let t=!1,n=0,r=0,s=0,o=0;i.addEventListener("mousedown",a=>{if(a.target.tagName==="BUTTON"||a.target.tagName==="SELECT")return;t=!0;const l=e.getBoundingClientRect();n=a.clientX,r=a.clientY,s=l.left,o=l.top,e.style.left=l.left+"px",e.style.top=l.top+"px",e.style.right="auto",e.style.bottom="auto",a.preventDefault()}),document.addEventListener("mousemove",a=>{if(!t)return;const l=a.clientX-n,c=a.clientY-r;e.style.left=s+l+"px",e.style.top=o+c+"px"}),document.addEventListener("mouseup",()=>{t=!1})}}async function kE(i){if(!(!Yi||!_r||!kn)){Yi.classList.add("visible"),_r.innerHTML="",vr==null||vr.classList.remove("visible"),kn&&(kn.style.display="block",kn.textContent="Loading snapshots..."),qd&&(qd.textContent=`Snapshots: ${i.slice(0,8)}`);try{const t=await(await fetch(`${Al}/objects/${i}/snapshots`)).json();if(t.error){kn&&(kn.textContent=`Error: ${t.error}`);return}if(No=t.snapshots||[],No.length===0){kn&&(kn.textContent="No snapshots available");return}kn&&(kn.style.display="none"),No.forEach((n,r)=>{const s=document.createElement("img");s.className="gallery-thumb"+(r===0?" selected":""),s.src=n.data,ki!=null&&ki.value&&ki.value!=="0"&&(s.style.transform=`rotate(${ki.value}deg)`),s.alt=`Snapshot ${r+1}`,s.dataset.index=String(r),s.addEventListener("click",()=>jd(r)),_r.appendChild(s)}),jd(0),Yd&&(Yd.textContent=`${No.length} snapshot(s) | Most recent first`)}catch(e){console.error("[gallery] Failed to load snapshots:",e),kn&&(kn.style.display="block",kn.textContent="Failed to load snapshots")}}}function jd(i){if(!_r||!vr)return;_r.querySelectorAll(".gallery-thumb").forEach((t,n)=>{t.classList.toggle("selected",n===i)});const e=No[i];e&&(vr.src=e.data,vr.classList.add("visible"))}Bc==null||Bc.addEventListener("click",()=>{OE("clear"),Jo()});kc==null||kc.addEventListener("click",()=>{Jo(),Tn&&Tn.close()});const Va=document.getElementById("conn-status");function fl(){zo&&(zo.disabled=!cr),ko&&(ko.disabled=cr),Va&&(Va.classList.toggle("connected",cr),Va.classList.toggle("disconnected",!cr),Va.title=cr?"Connected":"Disconnected")}zo==null||zo.addEventListener("click",()=>{qu=!0,Jo(),Pn=[],Tr(),ts(),Tn&&(Tn.close(),Tn=null),fl()});ko==null||ko.addEventListener("click",()=>{qu=!1,ju()});const Al="";Nr==null||Nr.addEventListener("click",async()=>{var i,e,t,n,r,s;if(confirm("Reset RTSM? This will clear all objects, keyframes, and sweep state.")){Nr.disabled=!0,Nr.textContent="Resetting...";try{const a=await(await fetch(`${Al}/reset`,{method:"POST"})).json();console.log("[RTSM] Reset result:",a),Jo(),Pn=[],Tr(),ts(),Oi(),alert(`RTSM Reset Complete!
...
`+r.join(`
`)+`
`}zc==null||zc.addEventListener("click",()=>{const{positions:i,colors:e}=HE();if(i.length===0){console.log("[demo] No points to export");return}const t=GE(i,e),n=new Blob([t],{type:"application/octet-stream"}),r=URL.createObjectURL(n),s=document.createElement("a");s.href=r,s.download="rtsm_pointcloud.ply",document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(r),console.log(`[demo] Exported ${i.length/3} points`)});let Wo=!1,Xo=!1,$i=!1,hl=0,Ku=0,Zu=!1,Ju=!1,Qu=!1,wl=!1;function jc(i){if(i){const e=pt.getAzimuthalAngle();pt.minAzimuthAngle=e-1e-4,pt.maxAzimuthAngle=e+1e-4}else pt.minAzimuthAngle=-1/0,pt.maxAzimuthAngle=1/0}function $c(i){if(i){const e=pt.getPolarAngle();pt.minPolarAngle=Math.max(0,e-1e-4),pt.maxPolarAngle=Math.min(Math.PI,e+1e-4)}else pt.minPolarAngle=1e-4,pt.maxPolarAngle=Math.PI-1e-4}function qi(){if($i){zs("Roll-only");return}Wo&&!Xo?($c(!1),jc(!0),zs("Pitch-only")):Xo&&!Wo?(jc(!1),$c(!0),zs("Yaw-only")):(jc(!1),$c(!1),zs("Free"))}function ef(){Wo=!1,Xo=!1,qi()}pt.addEventListener("start",()=>{wl=!0});pt.addEventListener("end",()=>{wl=!1,ef()});ii.domElement.addEventListener("pointerdown",i=>{i.button===0&&(Ku=i.clientX,Qu?($i=!0,hl=i.clientX,pt.enableRotate=!1,qi(),i.preventDefault()):Ju?(Xo=!0,qi()):Zu&&(Wo=!0,qi()))},{capture:!0});ii.domElement.addEventListener("pointerup",i=>{i.button===0&&($i?($i=!1,pt.enableRotate=!0,qi()):ef())},{capture:!0});ii.domElement.addEventListener("pointermove",i=>{if(Ku=i.clientX,!$i)return;const e=i.clientX-hl;if(e!==0){const t=new k().subVectors(pt.target,dn.position).normalize(),n=new Sr().setFromAxisAngle(t,e*.005);dn.up.applyQuaternion(n).normalize(),dn.lookAt(pt.target),hl=i.clientX}i.preventDefault()},{capture:!0});document.addEventListener("keydown",i=>{(i.key==="z"||i.key==="Z")&&(Zu=!0),(i.key==="x"||i.key==="X")&&(Ju=!0),(i.key==="c"||i.key==="C")&&(Qu=!0),wl&&(i.key==="c"||i.key==="C"?$i||($i=!0,hl=Ku,pt.enableRotate=!1,qi()):i.key==="x"||i.key==="X"?(Xo=!0,qi()):(i.key==="z"||i.key==="Z")&&(Wo=!0,qi()))});document.addEventListener("keyup",i=>{(i.key==="z"||i.key==="Z")&&(Zu=!1),(i.key==="x"||i.key==="X")&&(Ju=!1),(i.key==="c"||i.key==="C")&&(Qu=!1),wl&&((i.key==="c"||i.key==="C")&&$i?($i=!1,pt.enableRotate=!0,qi()):(i.key==="x"||i.key==="X"||i.key==="z"||i.key==="Z")&&ef())});const wo=new ES,Kc=new Ye;ii.domElement.addEventListener("dblclick",i=>{const e=ii.domElement.getBoundingClientRect();if(Kc.x=(i.clientX-e.left)/e.width*2-1,Kc.y=-((i.clientY-e.top)/e.height)*2+1,wo.setFromCamera(Kc,dn),Vn){wo.params.Points.threshold=.01;const t=wo.intersectObject(Vn,!1);if(t.length>0){pt.target.copy(t[0].point),pt.update();return}}for(const t of Wn.values()){wo.params.Points.threshold=.01;const n=wo.intersectObject(t,!1);if(n.length>0){pt.target.copy(n[0].point),pt.update();return}}});function Um(){if(requestAnimationFrame(Um),Gn&&Gn.visible){const i=performance.now()/1e3,e=.5+.5*Math.sin(i*Math.PI*4),t=Gn.material;t.opacity=.4+e*.6;const n=1+e*.15;Gn.scale.set(n,n,n)}if(Xi){const i=Uo.get(Xi);if(i){const e=performance.now()/1e3,t=.5+.5*Math.sin(e*Math.PI*4);i.material.color.setHex(t>.5?56831:2003199);const n=1.5+t*.5;i.scale.set(n,n,n)}}ii.render(Zo,dn)}window.addEventListener("resize",()=>{dn.aspect=window.innerWidth/window.innerHeight,dn.updateProjectionMatrix(),ii.setSize(window.innerWidth,window.innerHeight)});let Yo=!1,ct=[],Bi=[],Er={},Vt=null,Qs=null,eo=null,xr=null,Wa=!1;const Ro=document.getElementById("analytics-config-toggle");function $d(i,e){const t=Date.now()/1e3-e;for(;i.length>0&&i[0].wall_ts<t;)i.shift()}function VE(i){var e,t,n,r,s,o;i.mode==="full"?(ct=((e=i.latency)==null?void 0:e.hourly)??[],Bi=((t=i.segmentation)==null?void 0:t.hourly)??[],i.config&&(Vt=i.config,Yo&&(Im(),Nm()))):i.mode==="append"&&((n=i.latency)!=null&&n.bucket&&(ct.push(i.latency.bucket),$d(ct,3600)),(r=i.segmentation)!=null&&r.bucket&&(Bi.push(i.segmentation.bucket),$d(Bi,3600))),Er={latency:(s=i.latency)==null?void 0:s.aggregate,segmentation:(o=i.segmentation)==null?void 0:o.aggregate},Yo&&Fm()}function WE(i){document.querySelectorAll("#tab-bar .tab-btn").forEach(n=>n.classList.toggle("active",n.dataset.tab===i));const e=document.getElementById("view-3d"),t=document.getElementById("view-analytics");i==="3d"?(e&&(e.style.display="block"),t&&(t.style.display="none"),Yo=!1):(e&&(e.style.display="none"),t&&(t.style.display="block"),Yo=!0,jE(),Vt&&(Im(),Nm()),Fm())}var np;(np=document.getElementById("tab-bar"))==null||np.addEventListener("click",i=>{const e=i.target.closest(".tab-btn");e!=null&&e.dataset.tab&&WE(e.dataset.tab)});Ro==null||Ro.addEventListener("click",()=>{Wa=!Wa;const i=document.getElementById("analytics-config");i&&(i.style.display=Wa?"none":""),Ro&&(Ro.textContent=Wa?"Config ▸":"Config ▾")});function Im(){var l,c;const i=document.getElementById("analytics-config");if(!i||!Vt)return;const e=Vt.segmentation||{},t=Vt.receiver||{},n=Vt.pipeline||{},r=e.fastsam||{},s=e.yoloe||{},o=(u,f,d)=>`<span class="config-item"><span class="config-key">${u}:</span> <span class="${d?"config-highlight":"config-val"}">${f}</span></span>`;let a=[o("backend",e.backend,!0),o("device",n.device??"?"),o("retina",e.retina_masks??"?")];if(e.backend==="dual")a.push(o("fastsam",`${r.imgsz}px conf=${r.conf} iou=${r.iou}`),o("yoloe",`${s.imgsz}px conf=${s.conf} iou=${s.iou}`),o("dual-iou",(l=e.dual)==null?void 0:l.iou_confirm_threshold),o("prefer",(c=e.dual)==null?void 0:c.prefer_mask));else{const u=e[e.backend]||{};a.push(o("imgsz",`${u.imgsz}px`),o("conf",u.conf),o("max-det",u.max_det))}a.push(o("kf-every",`${t.keyframe_every_n}f`),o("throttle",`${t.nonkf_min_interval_s}s`),o("queue",t.queue_maxsize),o("top-k",n.topk_preclip)),i.innerHTML=`<div class="config-grid">${a.join("")}</div>`}function Nm(){var t;const i=document.querySelector("#analytics-seg-section .chart-section-label");if(!i||!Vt)return;const e=(t=Vt.segmentation)==null?void 0:t.backend;e==="dual"?i.textContent="Segmentation (Dual Confirmation)":i.textContent=`Segmentation (${e} only)`}function Fm(){XE(),YE(),qE(),KE()}function Ni(i,e,t){const n=document.getElementById(i);if(!n)return;const r=n.querySelector(".kpi-value");r&&(r.textContent=e,r.className="kpi-value"+(t?" "+t:""))}function or(i,e){const t=document.getElementById(i);if(!t)return;const n=t.querySelector(".kpi-sub");n&&(n.textContent=e)}function XE(){var n,r,s;const i=Er.latency,e=Er.segmentation,t=ct.length>0?ct[ct.length-1]:null;if(i){Ni("kpi-input-hz",`${i.input_hz??0}`),Ni("kpi-proc-hz",`${i.processing_hz??0}`),or("kpi-proc-hz",`Hz (${((i.effective_ratio??0)*100).toFixed(0)}% ratio)`);const o=(n=i.t_total)!=null&&n.mean?(i.t_total.mean*1e3).toFixed(0):"—",a=(r=i.t_total)!=null&&r.p95?(i.t_total.p95*1e3).toFixed(0):"?",l=Number(o)>500?"yellow":Number(o)>1e3?"red":"";Ni("kpi-latency",o,l),or("kpi-latency",`ms mean (p95: ${a}ms)`);const c=(t==null?void 0:t.queue_depth_max)??0,u=(t==null?void 0:t.queue_drops)??0,f=u>0||c>400?"red":c>256?"yellow":"green";Ni("kpi-queue",`${c}`,f),or("kpi-queue",u>0?`/ 512 cap  (${u} drops!)`:"/ 512 cap");const d=document.getElementById("kpi-queue");d&&d.classList.toggle("congestion",u>0);const m=((i.mask_survival_rate??0)*100).toFixed(0);Ni("kpi-masks",`${i.mean_masks_in??0}`),or("kpi-masks",`→ ${i.mean_candidates??0} selected (${m}%)`)}if(e){const o=e.backend??((s=Vt==null?void 0:Vt.segmentation)==null?void 0:s.backend)??"?";o==="dual"?(Ni("kpi-dual",`${((e.dual_rate??0)*100).toFixed(0)}%`,"green"),or("kpi-dual",`dual | ${((e.fastsam_only_rate??0)*100).toFixed(0)}% fsam | ${((e.yoloe_only_rate??0)*100).toFixed(0)}% yoloe`)):(Ni("kpi-dual",`${e.mean_total??0}`),or("kpi-dual",`masks/frame (${o})`))}if(ct.length>0){let o=t;for(let v=ct.length-1;v>=0;v--)if((ct[v].wm_total??0)>0||(ct[v].frames_in_bucket??0)>0){o=ct[v];break}const a=(o==null?void 0:o.wm_confirmed)??0,l=(o==null?void 0:o.wm_total)??0,c=(o==null?void 0:o.wm_proto)??0,u=a>0?"green":l>0?"yellow":"";Ni("kpi-objects",`${a}`,u),or("kpi-objects",`confirmed / ${l} total (${c} proto)`);let f=0,d=0;for(const v of ct)f+=v.assoc_matched??0,d+=v.assoc_created??0;const m=f+d>0?(f/(f+d)*100).toFixed(0):"—";Ni("kpi-assoc",`${f}`,f>0?"green":""),or("kpi-assoc",`matched / ${d} new (${m}% match rate)`)}}function YE(){var r;const i=document.getElementById("analytics-latency-breakdown");if(!i)return;const e=Er.latency;if(!e){i.innerHTML="";return}const t=((r=e.t_total)==null?void 0:r.mean)??0,n=[{name:"Seg",stats:e.t_segmentation,color:"#ff6b6b"},{name:"Heur",stats:e.t_heuristics,color:"#ffd93d"},{name:"Score",stats:e.t_scoring,color:"#aaaaaa"},{name:"CLIP",stats:e.t_clip,color:"#6bcb77"},{name:"Assoc",stats:e.t_association,color:"#4d96ff"}];i.innerHTML='<div class="latency-breakdown">'+n.map(s=>{var c;const o=((c=s.stats)==null?void 0:c.mean)??0,a=(o*1e3).toFixed(0),l=t>0?(o/t*100).toFixed(0):"0";return`<div class="latency-item">
